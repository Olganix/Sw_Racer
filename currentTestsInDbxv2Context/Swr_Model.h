...
struct SWR_MODEL_Section48
{
	...
	uint8_t unk2;				// 2
	uint8_t unk3;				// 3
	uint32_t unk4;				// 4		//possible to have Texture.
} PACKED;
...
public:
	...
	*/
	...
	void write_Xml(TiXmlElement *parent, const uint8_t *buf, size_t size, LibXenoverse::EMD* emd, LibXenoverse::EMM* emm, LibXenoverse::ESK* esk, LibXenoverse::EAN* ean, LibXenoverse::EMD* emd_collision);
